...
open class TapToRespondView: UIView {

    /// An array of `UITextField` outlets that will respond to the tap gesture.
    @IBOutlet public var firstResponders: [UITextField]!
    ...
    @objc public func handleTap(_ gestureRecognizer: UITapGestureRecognizer) {
